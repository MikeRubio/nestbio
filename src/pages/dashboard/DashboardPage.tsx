...
import { BarChart2, ExternalLink, Link as LinkIcon, PlusCircle, Users } from 'lucide-react';
  ...
  return (
    <div className="max-w-5xl mx-auto">
      <header className="mb-8">
        <h1 className="text-2xl font-bold mb-2">Welcome to your Linko dashboard</h1>
        <p className="text-gray-600 dark:text-gray-400">Manage all your links and customize your profile.</p>
      </header>
        ...
        >
          <div>
            <h2 className="text-lg font-medium text-primary-700 dark:text-primary-300">
              Your Linko page is live!
            </h2>
            <p className="text-primary-600 dark:text-primary-400">
              linko.com/{profile.username}
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        >
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="p-2 rounded-full bg-blue-50 dark:bg-blue-900/20">
              <LinkIcon size={20} className="text-blue-500 dark:text-blue-400" />
            </div>
          </div>
        ...
        >
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">Profile views this month</p>
        </motion.div>
        ...
        >
          ...
          <p className="text-3xl font-bold mb-1">0</p>
          <p className="text-sm text-gray-600 dark:text-gray-400">Total clicks this month</p>
        </motion.div>
      </div>
      ...
      <div className="card overflow-visible">
        <div className="border-b border-gray-200 dark:border-gray-700 p-4 md:p-6 flex flex-col sm:flex-row justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              {links.length > 0 ? 'Manage your most recent links' : 'Add links to your profile'}
            </p>
          </div>
          <div>
            <Link to="/links">
          ...
          {isLoading ? (
            ...
            <div className="grid gap-4">
              ...
              {links.length > 3 && (
                <div className="text-center mt-2">
                  <Link to="/links" className="text-primary-600 dark:text-primary-400 hover:underline">
                    View all links
                  </Link>
                </div>
              )}
            ...
            <div className="text-center py-12">
              <div className="inline-block p-3 rounded-full bg-gray-100 dark:bg-gray-800 mb-4">
                <LinkIcon size={32} className="text-gray-500 dark:text-gray-400" />
              </div>
